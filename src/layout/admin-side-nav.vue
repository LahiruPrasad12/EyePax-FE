  ...
  <div class="container" style="margin-top: 2%">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem; height: 10px">
      <a class="d-block p-3 link-dark text-decoration-none" data-bs-original-title="Icon-only" data-bs-placement="right" data-bs-toggle="tooltip"
         href="/" title="">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-browser-edge" viewBox="0 0 16 16">
      ...
      <ul class="nav nav-pills nav-flush flex-column mb-auto text-center mb-2">
        <b-tooltip label="Dashboard"
                   type="is-dark"
        ...
        <b-tooltip label="Staff"
                   type="is-dark"
                   position="is-left" target="">
          <li class="mb-3">
            <a class="nav-link py-3 border-bottom" data-bs-original-title="Staff" href="/#/admin/staff"
               title="">
        ...
        <b-tooltip label="Supplier"
                   type="is-dark"
                   position="is-left" target="">
          <li class="mb-3">
            <a class="nav-link py-3 border-bottom" data-bs-original-title="Supplier" href="/#/supplier/home"
               title="">
        ...
        <b-tooltip label="Delivery"
                   type="is-dark"
                   position="is-left" target="">
          <li class="mb-3">
            <a class="nav-link py-3 border-bottom" data-bs-original-title="Orders" data-bs-placement="right" data-bs-toggle="tooltip" href="#"
               title="">
        ...
        <b-tooltip label="Sign off"
                   type="is-dark"
                   position="is-left" target="">
          <li class="mb-3">
            <a class="nav-link py-3 border-bottom" data-bs-original-title="Products" data-bs-placement="right" data-bs-toggle="tooltip" href="#"
               title="">
