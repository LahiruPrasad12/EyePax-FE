<template>
  ...
  <div class="main-container" style="width: 1000px;">
    <div class="anim" style="--delay:0.2s;">
      <h1 style="text-align:center; font-size: 30px; color: white; margin-top: 2%; font-weight: 600;">Item Management</h1>
      <br/><br/>
    </div>
    <div class="anim" style="--delay:0.2s;">
      <header class="card-header" style="background-color: rgba(21, 20, 26, 0.63); border-radius: 20px;">
        <div class="card-header-title">
            ...
            <b-select v-model="selected_status" placeholder="Select Status" style="margin-left: 5%;">
                ...
                <option style="color: rgb(180, 180, 180);" value="true">Active</option>
                <option style="color: rgb(180, 180, 180);" value="false">Deactive</option>
              </b-select>
            </div>     
          <div class="float-end">
  ...
  watch: {
    selected_status() {
      this.filterItem(this.selected_status)
    }
  },
  ...
  methods: {
    ...
    filterItem(status) {
    this.$refs.all_items.getAllItems(status)
    },
