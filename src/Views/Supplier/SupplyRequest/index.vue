<template>
        ...
        <header class="card-header" style="background-color: rgba(21, 20, 26, 0.63); border-radius: 20px;">
          <div class="card-header-title">
              ...
              <div class="search-bar">
                <input type="text" placeholder="Search Requests" style="margin-left:15%;"> 
              </div>
              <b-select  v-model="selected_status" placeholder="Select Status" style="margin-left: 5%; color: rgb(180, 180, 180);">
    ...
    <script>
      import AllRequests from "../SupplyRequest/includes/Allrequests";
      export default {
        name: "index",
        components: {AllRequests},
        data(){
          return{
            selected_status: ''
          }
        ...
        filterUser(status) {
        this.$refs.all_requests.getAllRequests(status)
        },

        generate() {
        this.$refs.all_requests.generatePDF()
        }
